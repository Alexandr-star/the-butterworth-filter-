...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.labelExept = QtWidgets.QLabel(self.centralwidget)
        self.labelExept.setGeometry(QtCore.QRect(10, 340, 171, 16))
        self.labelExept.setObjectName("labelExept")
        self.labelOrder = QtWidgets.QLabel(self.centralwidget)
        self.labelOrder.setGeometry(QtCore.QRect(10, 400, 171, 16))
        ...
        #self.filtrSignalWidget.setEnabled(True)
